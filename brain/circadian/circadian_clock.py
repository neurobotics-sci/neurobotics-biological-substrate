"""
circadian/circadian_clock.py — Brain v8.4
...
PHASE SCHEDULE (entrained to real clock for Brain):
  The circadian phase is mapped to wall-clock time so Brain's
...
SLEEP OSCILLATIONS:
  ...
  REM/dreaming: theta dominant (6-8 Hz), cortex active, body paralysed
    ...
    → Brain generates dream sequences: random memory combinations
