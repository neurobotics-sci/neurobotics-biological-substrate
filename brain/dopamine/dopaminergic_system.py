"""
dopamine/dopaminergic_system.py — Brain v8.4
...
Its computational role is reward prediction error (RPE):
  ...
  γ    = discount factor (0.95 in Brain)
...
class PersonalityState:
    """Brain's current motivational state — modulated by tonic DA."""
    ...
    def incentive_salience(self, novelty: float) -> float:
        """How much Brain 'wants' a novel stimulus."""
