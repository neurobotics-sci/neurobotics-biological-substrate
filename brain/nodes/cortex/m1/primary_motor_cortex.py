"""
brain/nodes/cortex/m1/primary_motor_cortex.py — Brain v6000
...
from brain.shared.homunculus.somatosensory_homunculus import SomatosensoryHomunculus
from brain.shared.kinematics.hand_kinematics import OmniHand, GraspMode
...
if __name__ == "__main__":
    with open("/etc/brain/config.json") as f: cfg=json.load(f)["pfc_l"]
