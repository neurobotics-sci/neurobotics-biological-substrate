"""brain/nodes/spinal/legs/spinal_legs_node.py — v11.14
...
from brain.shared.kinematics.biomimetic_ik import make_human_leg
from brain.shared.reflexes.spinal_reflexes import LocomotorCPG,FlexorWithdrawalReflex
...
if __name__=="__main__":
    with open("/etc/brain/config.json") as f: cfg=json.load(f)["spinal_legs"]
