"""
brain/nodes/subcortical/hypothalamus/hypothalamus_node.py
...
from brain.shared.neuromodulators.neuromod_system import NeuromodulatorSystem
from brain.shared.watchdog.node_watchdog import NodeWatchdog
from brain.thermal.thermal_regulation import ThermalRegulationLoop
from brain.vagus.vagus_nerve import VagusNerve
    ...
    def _loop(self):
        ...
        while self._running:
           ...
           #pub_rate_scale = thermal.pub_scale
            pub_rate_scale = 1.0 # Float from 0.0 to 1.0 with 1.0 being nominal
