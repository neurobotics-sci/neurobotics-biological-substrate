"""
brain/nodes/thalamus/core_r/thalamus_r_node.py
Thalamus-R: Motor/PFC relay
...
class ThalamicRNode:
    ...
    def _on_pfc(self, msg):
        with self._lock: self._pfc_cmd = msg.payload
    ...
    def _relay_loop(self):
        ...
        while self._running:
            ...
            with self._lock:
                ...
                pfc  = dict(self._pfc_cmd); cea = self._amyg_cea
