"""
brain/nodes/thalamus/distributed/distributed_thalamus.py — Bubo Sapiens Brain
...
══════════════════════════════════════════════════════════════════════
CONFIGURATIONS FOR BRAIN (current and suggested)
══════════════════════════════════════════════════════════════════════
...
NUCLEUS_MAP = {
    "thalamus-l": {
        ...
        "MGN":  {"function":"auditory relay","inputs":["A1"],"outputs":["PFC","broca"]},
    ...
    "thalamus-r": {
        ...
        "MD":     {"function":"PFC↔limbic","inputs":["amygdala","hippocampus"],"outputs":["PFC","broca"]},
