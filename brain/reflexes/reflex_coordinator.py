"""
brain/reflexes/reflex_coordinator.py — v50.0
...
class TonicLabyrinthineReflex:
    ...
    Used in Brain for automatic postural adaptation on inclines.
    """
...
class AsymmetricTonicNeckReflex:
    ...
    Useful in Brain: pre-positions reaching arm in direction of gaze.
    """
    YAW_THRESH_DEG = 15.0
    GAIN = 0.25
...
class MoroReflex:
    ...
    Adapted for Brain as emergency fall-catch response.
