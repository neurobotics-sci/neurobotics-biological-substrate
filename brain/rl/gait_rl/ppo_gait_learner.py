"""
brain/rl/gait_rl/ppo_gait_learner.py — Brain v6500

PPO (Proximal Policy Optimization) Self-Supervised Gait Learning
Solves Gap 2d: Self-Supervised Skill Acquisition (0.2%)

════════════════════════════════════════════════════════════════════
PROBLEM: BRAIN CAN'T LEARN TO WALK BETTER FROM ITS OWN EXPERIENCE
════════════════════════════════════════════════════════════════════

Current v6000: CPG parameters are hand-tuned constants. Brain cannot
...
POLICY_PATH = Path("/opt/brain/models/gait_policy.npz")
REPLAY_PATH = Path("/opt/brain/data/gait_replay.npz")
