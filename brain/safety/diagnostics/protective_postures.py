"""
brain/safety/diagnostics/protective_postures.py — Brain v10000
...
DESIGN PRINCIPLE — "CLUTCHED UP":
  ...
  to anyone watching — a natural social signal.

  The protective posture serves TWO purposes:
  1. Physical: prevents further mechanical damage to the joint
  2. Social: visible signal to humans that something is wrong
     "Why is Brain holding its arm like that?" → because it's hurt.
...
COMPENSATION PATTERNS:
  ...
  If a leg is damaged:
    ...
    → Human is asked to help Brain sit down
"""
...
from brain.safety.diagnostics.fault_model import FaultSeverity
...
class ProtectivePosture:
    ...
    verbal_cue:     str      # what Brain says when it adopts this posture
    recovery_cue:   str      # what Brain says when fault resolves
