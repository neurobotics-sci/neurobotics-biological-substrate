"""
brain/shared/hal/servo_hal.py — Brain v5400
...
DYNAMIXEL PROTOCOL (recommended for Brain):
  ...
  This gives Brain REAL proprioception and the Insula a real fatigue signal.
