"""
brain/shared/homunculus/somatosensory_homunculus.py — Brain v6000
...
BIOLOGY:
  ...
  Brain's homunculus is discretised into 64 receptive field zones.
...
HAND INTEGRATION (v6000):
  ...
  This is the most densely-represented region of Brain's homunculus.
"""
...
def build_homunculus() -> Dict[str, ReceptiveField]:
    """
    Build the complete somatosensory homunculus for Brain.
