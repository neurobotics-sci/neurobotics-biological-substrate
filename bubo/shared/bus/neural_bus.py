...
class T:
    ...
    BROCA_SPEECH_ACT=b"BRC_SPEECH";BROCA_SYNTAX=b"BRC_SYNTAX";BROCA_MOTSEQ=b"BRC_MOTSEQ"
    ...
    SOCIAL_FACE=b"SOC_FACE";SOCIAL_BOND=b"SOC_BOND";SOCIAL_THREAT_MOD=b"SOC_THRMOD"
    SOCIAL_APPROACH=b"SOC_APPROACH";SOCIAL_OXY=b"SOC_OXY"
    # LLM (v5900)
